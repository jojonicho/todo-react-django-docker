...
var _extends = _interopDefault(require("@babel/runtime/helpers/extends")), _objectWithoutPropertiesLoose = _interopDefault(require("@babel/runtime/helpers/objectWithoutPropertiesLoose")), syntaxJsx = _interopDefault(require("@babel/plugin-syntax-jsx")), nodePath = _interopDefault(require("path")), sourceMap = require("source-map"), convert = _interopDefault(require("convert-source-map")), findRoot = _interopDefault(require("find-root")), memoize = _interopDefault(require("@emotion/memoize")), hashString = _interopDefault(require("@emotion/hash")), escapeRegexp = _interopDefault(require("escape-string-regexp")), serialize = require("@emotion/serialize"), stylis = require("stylis"), helperModuleImports = require("@babel/helper-module-imports"), babelPluginMacros = require("babel-plugin-macros"), invalidClassNameCharacters = /[!"#$%&'()*+,./:;<=>?@[\]^`|}~{]/g, sanitizeLabelPart = function(labelPart) {
...
var appendStringReturningExpressionToArguments = function(t, path, expression) {
  ...
  if (t.isStringLiteral(last)) "string" == typeof expression ? path.node.arguments[lastIndex].value += expression : path.node.arguments[lastIndex] = t.binaryExpression("+", last, expression); else {
    ...
    })) : "string" == typeof expression ? path.node.arguments.push(t.stringLiteral(expression)) : path.node.arguments.push(expression);
  }
